...
<html>
	...
	<body>
		...
		<h1 style="font-size: 45px; padding-top: 100px; padding-left: 20px; color:#3366FF;"><i class="fas fa-history"></i> About Us</h1>
		<section>
			...
			<center>
				<h style="font-size: 45px; padding: 20px; color:#3366FF;">About Courses</h>
			</center>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Computer Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Information Technology</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Civil Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Mechanical Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Electronics Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">BE In Electronics & Telecommunication Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 4 year<br>Fees : 4,20,000<br>Seats Availability : 60</h>
			</a-side>	
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">ME In Computer Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 2 year<br>Fees : 1,50,000<br>Seats Availability : 24</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">ME In Electronics & Telecommunication Engineering</h>
				</center>
				<br><br><br><h style="font-size: 20px;">Course Duration : 2 year<br>Fees : 1,50,000<br>Seats Availability : 24</h>
			</a-side>
			<a-side>
				<center>
					<br><br><h style="font-size: 30px;">Be Happy !!!</h>
				</center>
			</a-side>
			<h style="color: white">SLRTCE</h><br><br>
			<div class="commit">
				<center>
